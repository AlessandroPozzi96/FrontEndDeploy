...
import { Image, Heading, RowType, Toggle, Text, CardBody, Card } from '@pancakeswap-libs/uikit'
...
import MainColor from '../../config/constants/constantes';
import "./Farm.css";
...
const Farms: React.FC = () => {
  ...
  const farm1 : FarmConfig = {
    pid: 0,
    lpSymbol: 'Armadillo-BNB LP',
    lpAddresses: {
      97: '0xe70b7523f4bffa1f2e88d2ba709afd026030f412',
      56: '0x6e046E5BbA2C3b63f44D97262570D45522710D9A',
    },
    tokenSymbol: 'Armadillo',
    tokenAddresses: {
      97: '0xe9e7cea3dedca5984780bafc599bd69add087d56',
      56: '0x6e046E5BbA2C3b63f44D97262570D45522710D9A',
    },
    quoteTokenSymbol: QuoteToken.BNB,
    quoteTokenAdresses: wbnb,
  };

  const farm2 : FarmConfig = {
    pid: 1,
    lpSymbol: 'Armadillo-BNB LP',
    lpAddresses: {
      97: '0xe70b7523f4bffa1f2e88d2ba709afd026030f412',
    ...
    <>
      ...
      <StyledCakeStats>
        <CardBody id="homeCardBody">
          <Heading size="xl" mb="24px" color="rgb(62, 61, 67);">
            {TranslateString(999, 'Stake Liquidity Pool (LP) tokens to earn.')}
          </Heading>
        </CardBody>
      </StyledCakeStats>
